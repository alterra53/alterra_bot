...
# ---------------------------------------------------
# CONFIG — minden adat env változóból
# ---------------------------------------------------
...
# ---------------------------------------------------
# Állapot memória (teszthez) — később DB
# ---------------------------------------------------
...
class StartVerificationButton(discord.ui.View):
    ...
    @discord.ui.button(label="Start Verification", style=discord.ButtonStyle.primary, custom_id="start_verification_user")
    async def start(self, interaction: discord.Interaction, button: discord.ui.Button):
        if interaction.user.id != self.user_id:
            return await interaction.response.send_message("Ez a gomb nem neked szól.", ephemeral=True)
...
class FinalConfirmButton(discord.ui.View):
    ...
    @discord.ui.button(label="Confirm Verification", style=discord.ButtonStyle.success, emoji="☑️", custom_id="final_confirm")
    async def confirm(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        if not member or not role:
            return await interaction.response.send_message("Felhasználó vagy szerep nem található.", ephemeral=True)
...
async def setup(ctx: commands.Context):
    ...
    view.add_item(discord.ui.Button(label="Start Verification", style=discord.ButtonStyle.primary, custom_id="start_verification"))
...
# ---------------------------------------------------
async def start_api():
    config = Config(app=app, host="0.0.0.0", port=8000, log_level="info", loop="asyncio")
